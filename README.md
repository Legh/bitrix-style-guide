...
- Включаемые файлы распологаются в каталоге `includes`
- Все дополнительные файлы (скрипты, стили, изображения и т.д.) распологаются в каталоге `assets`:
    - `js` - свои скрипты и однофайловые библиотеки
    - `css` - свои стили и однофайловые библиотеки
    - `images` - изображения, спрайты, иконки
    - `fonts` - шрифты
    - остальные библиотеки и фреймворки распологаются в каталогах, названия которых совпадают с названием и версией библиотеки, при этом сохраняется внутренняя структура дистрибутива.
